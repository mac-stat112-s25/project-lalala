...
```
##Data Insights
In pursuit of a better understanding of the data, we started by graphing all points ina simple plot, where Metascore was represented on the y-axis, and average time to beat the main story represented on the x. Note that the range of x is always constricted in our visualizations because of the presence of outliers reaching as far as 248 hours to beat on average.
###Scatter Plot of Metascore and Length
```{r}
USETHISONE |>
...
###2D density plot of Metascore and Length
```{r}
USETHISONE |>
...
o	(FIRST GRAPH WITH LINE HAND DRAWN ON THERE)
